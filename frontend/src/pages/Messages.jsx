...
export default function Messages() {
  ...
  return (
    <div className="h-[calc(100vh-8rem)] flex gap-0 p-4">
      {/* Sidebar */}
      <div className="w-72 shrink-0 flex flex-col bg-sidebar rounded-l-xl border-r border-border/50 overflow-hidden">
      ...
      {/* Chat Area */}
      <div className="flex-1 flex flex-col bg-card rounded-r-xl border overflow-hidden">
        {!selectedConn ? (
